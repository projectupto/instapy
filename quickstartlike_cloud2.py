...
PRODUCTION = True
VERSION = "jimmy-follower-comment"
######################################
# configuration
#
# main customization
SLEEP_BETWEEN_EACH_FOLLOW = 20
SLEEP_BETWEEN_EACH_UNFOLLOW = 20
SLEEP_AFTER_ALL_FOLLOW = 200
SLEEP_AFTER_ALL_LIKE = 240
...
DEFAULT_USERNAME = 'jimmy_cai8'
DEFAULT_PASSWORD = 'Caijijun12'
#
...
def main():
    ...
    with smart_run(session):
        while True:
           ...
           logger.warning(SLEEP_AFTER_ALL_LIKE)
           time.sleep(SLEEP_AFTER_ALL_LIKE)
